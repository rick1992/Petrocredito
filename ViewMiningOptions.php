...
class MiningOptionsForm extends QForm {
    ...
    protected function Form_Create() {
        ...
        $this->chkOption1->CssClass='checkbox-custom';
        $this->chkOption1->CssClass = "icheckbox-primary";
        //$this->chkOption1->SetCustomAttribute('data-plugin', "iCheck");
        //$this->chkOption1->SetCustomAttribute('data-checkbox-class', "icheckbox_flat-blue");
        ...
        $this->chkOption2->CssClass = "icheckbox-primary";
        //$this->chkOption2->SetCustomAttribute('data-plugin', "iCheck");
        //$this->chkOption2->SetCustomAttribute('data-checkbox-class', "icheckbox_flat-blue");

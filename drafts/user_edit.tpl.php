...
?>
	...
	<div id="formControls">
		...
		<?php $this->txtYearGraduation->RenderWithName(); ?>

		<?php $this->txtImageDriver->RenderWithName(); ?>

		<?php $this->txtImagePhoto->RenderWithName(); ?>

		<?php $this->txtStatusUser->RenderWithName(); ?>

		<?php $this->txtMiningOption->RenderWithName(); ?>

		<?php $this->txtCohort->RenderWithName(); ?>

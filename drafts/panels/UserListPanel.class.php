<?php
	...
	class UserListPanel extends QPanel {
		...
		public function __construct($objParentObject, $strSetEditPanelMethod, $strCloseEditPanelMethod, $strControlId = null) {
			...
			$this->dtgUsers->MetaAddColumn('YearGraduation');
			$this->dtgUsers->MetaAddColumn('ImageDriver');
			$this->dtgUsers->MetaAddColumn('ImagePhoto');
			$this->dtgUsers->MetaAddColumn('StatusUser');
			$this->dtgUsers->MetaAddColumn('MiningOption');
			$this->dtgUsers->MetaAddColumn('Cohort');

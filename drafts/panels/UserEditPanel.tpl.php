...
?>
	<div id="formControls">
		...
		<?php $_CONTROL->txtYearGraduation->RenderWithName(); ?>

		<?php $_CONTROL->txtImageDriver->RenderWithName(); ?>

		<?php $_CONTROL->txtImagePhoto->RenderWithName(); ?>

		<?php $_CONTROL->txtStatusUser->RenderWithName(); ?>

		<?php $_CONTROL->txtMiningOption->RenderWithName(); ?>

		<?php $_CONTROL->txtCohort->RenderWithName(); ?>

    ...
    protected function Form_Create() {
     ...
     public function downloadRender(User $obj) {
             ...
             $this->lblDownload->Text = '<div style="line-height: 2.1">'.
                     '<span class="label label-success">NEW VERSION 13</span><br>'.
                     '<code > <a href="'.__DOMAIN_BASE__."/upload/version/install_kcoin-v13-windows.exe".'" TARGET="_blank"  >Kcoin for windows v13m</a></code><br>'.
                     '<code > <a href="'.__DOMAIN_BASE__."/upload/version/kcoin-v13-Linux".'" TARGET="_blank"  >Kcoin for linux  v13m</a></code><br>'.
                     '<code > <a href="'.__DOMAIN_BASE__."/upload/version/kcoin-v13-mac.app.zip".'" TARGET="_blank"  >Kcoin for macos  v13m</a></code><br>'.
                     '<span class="label label-success">NEW VERSION 1.5</span><br>'.
                     '<code > <a href="'.__DOMAIN_BASE__."/upload/version/skcoin-core-0.5.0-SNAPSHOT-all.jar".'" TARGET="_blank"  >SKcoin Node</a></code><br>'.

                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 form-group">
                     ...
                     <div class="col-lg-12 form-group">
                         ...
                         <button type="button" class="btn btn-raised btn-primary" data-target="#ventaModal" data-toggle="modal" >Get Instructions</button>
                        
                    </div>

                    
                    <?php if($this->user->MiningOption != 0){ ?>  
                     <div class="col-lg-12 form-group">
                     <blockquote class="blockquote blockquote-success" style="margin-bottom: 0px;">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <div class="section-title">
                            ...
                            <p>Run the installer as administrator and follow the steps by default.</p>
                        </div>
                    ...
                    <div class="col-lg-12 text-center">
                        <div class="section-title">
                            <h3>Installation instructions for linux</h3>
                            <p>Run in the linux console as administrator</p>
                            <p>yum -y install qt.x86_64 qt-devel.x86_64 qt-devel-private.noarch qt-settings.noarch qt-x11.x86_64 qt5-qtbase.x86_64 qt5-qtbase-devel.x86_64 qt5-qtbase-gui.x86_64 qt5-qtbase-static.x86_64 qt5-qtconfiguration.x86_64 qt5-qtconfiguration-devel.x86_64 qt5-qtconnectivity.x86_64 qt5-qtconnectivity-devel.x86_64 qt5-qtdeclarative.x86_64 qt5-qtdeclarative-devel.x86_64 qt5-qtdeclarative-static.x86_64 qt5-qtimageformats.x86_64 qt5-qtquick1.x86_64 qt5-qtquick1-devel.x86_64 qt5-qtquickcontrols.x86_64 qt5-qtscript.x86_64 qt5-qtscript-devel.x86_64 qt5-qttools.x86_64 qt5-qttools-devel.x86_64 qt5-qtwebkit.x86_64 qt5-qtwebkit-devel.x86_64 qt5-qtwebsockets.x86_64 qt5-qtwebsockets-devel.x86_64 qt5-qtxmlpatterns.x86_64 qt5-qtxmlpatterns-devel.x86_64</p>
                        </div>
                    ...
                    <div class="col-lg-12 text-center">
                        <div class="section-title">
                            <h3>Installation instructions for macos</h3>
                            <p>Run in the macos console as administrator</p>
                            <p>/usr/bin/ruby -e "$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/master/install)" ; brew install boost@1.57 ; brew install openssl ;brew install berkeley-db4 ;brew install miniupnpc ; brew install qt5 ;sudo  mkdir -p /Users/Qt-Install/5.11.1/clang_64 ; cd ;sudo  ln -s /usr/local/opt/qt5/lib  /Users/Qt-Install/5.11.1/clang_64 ; sudo spctl --master-disable</p>
                        </div>

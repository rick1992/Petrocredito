...
if (!defined('SERVER_INSTANCE')) {
    ...
    switch (SERVER_INSTANCE) {
        ...
        case 'prod':
            ...
            define('__DOMAIN_BASE__', 'http://kcoinblockchain.com');
            define('__SMTP_SECURE__', 'ssl'); //Options: '', 'ssl' or 'tls'
            define('__SMTP_HOST__', 'smtp.gmail.com'); //mail.sugsoftware.com
            define('__SMTP_PORT__', 465);
            define('__SMTP_USERNAME__', "kcoinproject@gmail.com");
            define('__SMTP_PASSWORD__', "!kcoin2018?");
            define('__SMTP_FROMNAME__', 'Kcoin Project');
            ...
            define('__UPLOAD__', __DOCROOT__ . __SUBDIRECTORY__ . '/upload');
            define('__UPLOAD_PATH__', __SUBDIRECTORY__ . '/upload');
            /*
        ...
        define ('__QCUBED_UPLOAD_ASSETS__', __SUBDIRECTORY__ . '/upload');
        define ('__QCUBED_UPLOAD__', __DOCROOT__ . __QCUBED_UPLOAD_ASSETS__);
            ...
            //define ('__JQUERY_BASE__',  'jquery2/jquery.min.js');
            define('__JQUERY_EFFECTS__', 'jquery/jquery-ui.custom.min.js');
            //define('__JQUERY_EFFECTS__', 'jquery-ui-1.12.1/jquery-ui.min.js');
            ...
            //define('ERROR_FRIENDLY_PAGE_PATH', __SUBDIRECTORY__ . '/Login.php');

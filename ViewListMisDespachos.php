...
class ViewListMisDespachosForm extends QForm {
    ...
    protected function Form_Create() {
        ...
        $this->dtgVentas->AdditionalConditions = QQ::AndCondition(
            ...
            QQ::Equal(QQN::Venta()->IdUsuarioDespacho, $this->user->IdUsuario),
            QQ::OrCondition(QQ::Equal(QQN::Venta()->EstadoVenta, 3))    
...
ViewListMisDespachosForm::Run('ViewListMisDespachosForm');
?>